    ...
    describe('inserting data', () => {
      ...
      it('should insert a row from buffer and get the same data back', async () => {
        ...
        const data = Uint8Array.from([
          ...
          0x55, 0xdd, 0xd5, 0x3f, 0x42, 0x42, 0xc4, 0x26, 0xea, 0xd7, 0xf6,
          0x13, 0x9e, 0x8f, 0xe6, 0x3d, 0x4b, 0xb3, 0x5, 0x44, 0xc4, 0x1e, 0x0,
          0xdb, 0x72, 0x0, 0xbb, 0x70, 0xe6, 0xdc, 0x88, 0xc5, 0xd0, 0x58, 0xb2,
          0xe4, 0xc4, 0x92, 0x25, 0x57, 0xd8, 0x5d, 0x75, 0xeb, 0xea, 0xdc,
