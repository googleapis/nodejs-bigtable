 ...
 */
export declare const gaxProtos: string;
/**
 *
 ...
 */
export declare function generateRootName(directories: string[]): Promise<string>;
/**
 ...
 * `./src` folder of the given client library.
 */
export declare function main(parameters: string[]): Promise<void>;
