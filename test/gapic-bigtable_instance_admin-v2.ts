...
describe('v2.BigtableInstanceAdminClient', () => {
    ...
    describe('partialUpdateInstance', () => {
        it('invokes partialUpdateInstance without error', done => {
            ...
            client.partialUpdateInstance(request).then((responses: [Operation]) => {
                const operation = responses[0];
                return operation? operation.promise() : {};
            }).then((responses: [Operation]) => {
                assert.deepStrictEqual(responses[0], expectedResponse);
    ...
    describe('updateAppProfile', () => {
        it('invokes updateAppProfile without error', done => {
            ...
            client.updateAppProfile(request).then((responses: [Operation]) => {
                const operation = responses[0];
                return operation? operation.promise() : {};
            }).then((responses: [Operation]) => {
                assert.deepStrictEqual(responses[0], expectedResponse);
    ...
    describe('listAppProfiles', () => {
        it('invokes listAppProfiles without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listAppProfiles = (actualRequest: {}, options: {}, callback: Callback) => {
    ...
    describe('listAppProfilesStream', () => {
        it('invokes listAppProfilesStream without error', done => {
            ...
            const stream = client.listAppProfilesStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
