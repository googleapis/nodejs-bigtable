...
describe('v2.BigtableClient', () => {
    ...
    describe('mutateRow', () => {
        ...
        it('invokes mutateRow with error', async () => {
            ...
            assert.rejects(async () => { await client.mutateRow(request); }, expectedError);
            assert((client.innerApiCalls.mutateRow as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('checkAndMutateRow', () => {
        ...
        it('invokes checkAndMutateRow with error', async () => {
            ...
            assert.rejects(async () => { await client.checkAndMutateRow(request); }, expectedError);
            assert((client.innerApiCalls.checkAndMutateRow as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('readModifyWriteRow', () => {
        ...
        it('invokes readModifyWriteRow with error', async () => {
            ...
            assert.rejects(async () => { await client.readModifyWriteRow(request); }, expectedError);
            assert((client.innerApiCalls.readModifyWriteRow as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
