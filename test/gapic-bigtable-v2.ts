...
describe('v2.BigtableClient', () => {
    ...
    describe('sampleRowKeys', () => {
        it('invokes sampleRowKeys without error', done => {
            ...
            const expectedResponse = {};
            // Mock gRPC layer
            client._innerApiCalls.sampleRowKeys = mockServerStreamingGrpcMethod(request, expectedResponse, null);
    ...
    describe('mutateRows', () => {
        it('invokes mutateRows without error', done => {
            ...
            const expectedResponse = {};
            // Mock gRPC layer
            client._innerApiCalls.mutateRows = mockServerStreamingGrpcMethod(request, expectedResponse, null);
