...
describe('v2.BigtableClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new bigtableModule.v2.BigtableClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'bigtable.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new bigtableModule.v2.BigtableClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'bigtable.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new bigtableModule.v2.BigtableClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new bigtableModule.v2.BigtableClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('mutateRow', () => {
        it('invokes mutateRow without error', async () => {
            ...
            request.authorizedViewName = 'projects/value/instances/value/tables/value/value';
            const expectedHeaderRequestParams = 'table_name=projects%2Fvalue%2Finstances%2Fvalue%2Ftables%2Fvalue';
            ...
            const actualRequest = (client.innerApiCalls.mutateRow as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.mutateRow as SinonStub)
        ...
        it('invokes mutateRow without error using callback', async () => {
            ...
            client.innerApiCalls.mutateRow = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.mutateRow(
                    request,
                    (err?: Error|null, result?: protos.google.bigtable.v2.IMutateRowResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('checkAndMutateRow', () => {
        it('invokes checkAndMutateRow without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.checkAndMutateRow as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.checkAndMutateRow as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes checkAndMutateRow without error using callback', async () => {
            ...
            client.innerApiCalls.checkAndMutateRow = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.checkAndMutateRow(
                    request,
                    (err?: Error|null, result?: protos.google.bigtable.v2.ICheckAndMutateRowResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes checkAndMutateRow with error', async () => {
            ...
            const expectedHeaderRequestParams = 'table_name=projects%2Fvalue%2Finstances%2Fvalue%2Ftables%2Fvalue';
            const expectedError = new Error('expected');
            client.innerApiCalls.checkAndMutateRow = stubSimpleCall(undefined, expectedError);
    ...
    describe('pingAndWarm', () => {
        it('invokes pingAndWarm without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.pingAndWarm as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.pingAndWarm as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes pingAndWarm without error using callback', async () => {
            ...
            client.innerApiCalls.pingAndWarm = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.pingAndWarm(
                    request,
                    (err?: Error|null, result?: protos.google.bigtable.v2.IPingAndWarmResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes pingAndWarm with error', async () => {
            ...
            const expectedHeaderRequestParams = 'app_profile_id=value';
            const expectedError = new Error('expected');
            client.innerApiCalls.pingAndWarm = stubSimpleCall(undefined, expectedError);
    ...
    describe('readModifyWriteRow', () => {
        it('invokes readModifyWriteRow without error', async () => {
            ...
            client.innerApiCalls.readModifyWriteRow = stubSimpleCall(expectedResponse);
            const [response] = await client.readModifyWriteRow(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.readModifyWriteRow as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.readModifyWriteRow as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes readModifyWriteRow without error using callback', async () => {
            ...
            client.innerApiCalls.readModifyWriteRow = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.readModifyWriteRow(
                    request,
                    (err?: Error|null, result?: protos.google.bigtable.v2.IReadModifyWriteRowResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes readModifyWriteRow with error', async () => {
            ...
            const expectedHeaderRequestParams = 'table_name=projects%2Fvalue%2Finstances%2Fvalue%2Ftables%2Fvalue';
            const expectedError = new Error('expected');
            client.innerApiCalls.readModifyWriteRow = stubSimpleCall(undefined, expectedError);
    ...
    describe('readRows', () => {
        it('invokes readRows without error', async () => {
            ...
            const expectedHeaderRequestParams = 'name=projects%2Fvalue%2Finstances%2Fvalue';
            const expectedResponse = generateSampleMessage(
    ...
    describe('sampleRowKeys', () => {
        it('invokes sampleRowKeys without error', async () => {
            ...
            client.innerApiCalls.sampleRowKeys = stubServerStreamingCall(expectedResponse);
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.sampleRowKeys as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.sampleRowKeys as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes sampleRowKeys with error', async () => {
            ...
            const expectedHeaderRequestParams = 'name=projects%2Fvalue%2Finstances%2Fvalue';
            const expectedError = new Error('expected');
            client.innerApiCalls.sampleRowKeys = stubServerStreamingCall(undefined, expectedError);
            const stream = client.sampleRowKeys(request);
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.bigtable.v2.SampleRowKeysResponse) => {
                    resolve(response);
    ...
    describe('mutateRows', () => {
        it('invokes mutateRows without error', async () => {
            ...
            client.innerApiCalls.mutateRows = stubServerStreamingCall(expectedResponse);
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.mutateRows as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.mutateRows as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes mutateRows with error', async () => {
            ...
            const expectedHeaderRequestParams = 'table_name=projects%2Fvalue%2Finstances%2Fvalue%2Ftables%2Fvalue';
            const expectedError = new Error('expected');
            client.innerApiCalls.mutateRows = stubServerStreamingCall(undefined, expectedError);
            const stream = client.mutateRows(request);
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.bigtable.v2.MutateRowsResponse) => {
                    resolve(response);
    ...
    describe('generateInitialChangeStreamPartitions', () => {
        it('invokes generateInitialChangeStreamPartitions without error', async () => {
            ...
            client.innerApiCalls.generateInitialChangeStreamPartitions = stubServerStreamingCall(expectedResponse);
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateInitialChangeStreamPartitions as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateInitialChangeStreamPartitions as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('readChangeStream', () => {
        it('invokes readChangeStream without error', async () => {
            ...
            client.innerApiCalls.readChangeStream = stubServerStreamingCall(expectedResponse);
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.readChangeStream as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.readChangeStream as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('executeQuery', () => {
        it('invokes executeQuery without error', async () => {
            ...
            client.innerApiCalls.executeQuery = stubServerStreamingCall(expectedResponse);
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.executeQuery as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.executeQuery as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes executeQuery with error', async () => {
            ...
            const expectedHeaderRequestParams = 'app_profile_id=value';
            const expectedError = new Error('expected');
            client.innerApiCalls.executeQuery = stubServerStreamingCall(undefined, expectedError);
            const stream = client.executeQuery(request);
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.bigtable.v2.ExecuteQueryResponse) => {
                    resolve(response);
