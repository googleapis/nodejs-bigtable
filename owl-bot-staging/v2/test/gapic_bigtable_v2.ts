...
describe('v2.BigtableClient', () => {
    ...
    describe('mutateRow', () => {
        it('invokes mutateRow without error', async () => {
            ...
            const expectedHeaderRequestParams = 'authorized_view_name=projects%2Fvalue%2Finstances%2Fvalue%2Ftables%2Fvalue%2FauthorizedViews%2Fvalue';
    ...
    describe('readRows', () => {
        ...
        it('invokes readRows without error and gaxServerStreamingRetries enabled', async () => {
            const client = new bigtableModule.v2.BigtableClient({gaxServerStreamingRetries: true});
            client.initialize();
            const request = generateSampleMessage(
              new protos.google.bigtable.v2.ReadRowsRequest()
            );
