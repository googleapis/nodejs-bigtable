...
describe('v2.BigtableClient', () => {
    ...
    describe('sampleRowKeys', () => {
        ...
        it('invokes sampleRowKeys with closed client', async () => {
            ...
            const expectedError = new Error('The client has already been closed.');
            client.close();
            const stream = client.sampleRowKeys(request, {retry: {shouldRetryFn: () => { return false; }}});
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.bigtable.v2.SampleRowKeysResponse) => {
                    resolve(response);
                });
    ...
    describe('mutateRows', () => {
        ...
        it('invokes mutateRows with closed client', async () => {
            ...
            const expectedError = new Error('The client has already been closed.');
            client.close();
            const stream = client.mutateRows(request, {retry: {shouldRetryFn: () => { return false; }}});
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.bigtable.v2.MutateRowsResponse) => {
                    resolve(response);
                });
    ...
    describe('generateInitialChangeStreamPartitions', () => {
        ...
        it('invokes generateInitialChangeStreamPartitions with closed client', async () => {
            ...
            const expectedError = new Error('The client has already been closed.');
            client.close();
            const stream = client.generateInitialChangeStreamPartitions(request, {retry: {shouldRetryFn: () => { return false; }}});
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.bigtable.v2.GenerateInitialChangeStreamPartitionsResponse) => {
                    resolve(response);
                });
    ...
    describe('readChangeStream', () => {
        ...
        it('invokes readChangeStream with closed client', async () => {
            ...
            const expectedError = new Error('The client has already been closed.');
            client.close();
            const stream = client.readChangeStream(request, {retry: {shouldRetryFn: () => { return false; }}});
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.bigtable.v2.ReadChangeStreamResponse) => {
                    resolve(response);
                });
