...
describe('v2.BigtableClient', () => {
    ...
    describe('mutateRow', () => {
        it('invokes mutateRow without error', async () => {
            ...
            expectedHeaderRequestParamsObj['table_name'] = 'projects%2Fvalue%2Finstances%2Fvalue%2Ftables%2Fvalue';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.bigtable.v2.MutateRowResponse());
            client.innerApiCalls.mutateRow = stubSimpleCall(expectedResponse);
            const [response] = await client.mutateRow(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateRow as SinonStub)
    ...
    describe('checkAndMutateRow', () => {
        it('invokes checkAndMutateRow without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.bigtable.v2.CheckAndMutateRowRequest());
            const expectedHeaderRequestParamsObj: {[key: string]: string} = {};
            // path template: {table_name=projects/*/instances/*/tables/*}
            request.tableName = 'projects/value/instances/value/tables/value';
            expectedHeaderRequestParamsObj['table_name'] = 'projects%2Fvalue%2Finstances%2Fvalue%2Ftables%2Fvalue';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.bigtable.v2.CheckAndMutateRowResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.checkAndMutateRow as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('pingAndWarm', () => {
        it('invokes pingAndWarm without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.bigtable.v2.PingAndWarmRequest());
            const expectedHeaderRequestParamsObj: {[key: string]: string} = {};
            // path template: {name=projects/*/instances/*}
            request.name = 'projects/value/instances/value';
            expectedHeaderRequestParamsObj['name'] = 'projects%2Fvalue%2Finstances%2Fvalue';
            // path template is empty
            request.appProfileId = 'value';
            expectedHeaderRequestParamsObj['app_profile_id'] = 'value';
            const expectedHeaderRequestParams = Object.entries(expectedHeaderRequestParamsObj).map(([key, value]) => `${key}=${value}`).join('&');
            ...
            const expectedResponse = generateSampleMessage(new protos.google.bigtable.v2.PingAndWarmResponse());
            client.innerApiCalls.pingAndWarm = stubSimpleCall(expectedResponse);
            const [response] = await client.pingAndWarm(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.pingAndWarm as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('readModifyWriteRow', () => {
        it('invokes readModifyWriteRow without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.bigtable.v2.ReadModifyWriteRowRequest());
            const expectedHeaderRequestParamsObj: {[key: string]: string} = {};
            // path template: {table_name=projects/*/instances/*/tables/*}
            request.tableName = 'projects/value/instances/value/tables/value';
            expectedHeaderRequestParamsObj['table_name'] = 'projects%2Fvalue%2Finstances%2Fvalue%2Ftables%2Fvalue';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.bigtable.v2.ReadModifyWriteRowResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.readModifyWriteRow as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('readRows', () => {
        it('invokes readRows without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.bigtable.v2.ReadRowsRequest());
            const expectedHeaderRequestParamsObj: {[key: string]: string} = {};
            // path template: {table_name=projects/*/instances/*/tables/*}
            request.tableName = 'projects/value/instances/value/tables/value';
            expectedHeaderRequestParamsObj['table_name'] = 'projects%2Fvalue%2Finstances%2Fvalue%2Ftables%2Fvalue';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.bigtable.v2.ReadRowsResponse());
    ...
    describe('sampleRowKeys', () => {
        it('invokes sampleRowKeys without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.bigtable.v2.SampleRowKeysRequest());
            const expectedHeaderRequestParamsObj: {[key: string]: string} = {};
            // path template: {table_name=projects/*/instances/*/tables/*}
            request.tableName = 'projects/value/instances/value/tables/value';
            expectedHeaderRequestParamsObj['table_name'] = 'projects%2Fvalue%2Finstances%2Fvalue%2Ftables%2Fvalue';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.bigtable.v2.SampleRowKeysResponse());
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.sampleRowKeys as SinonStub)
                .getCall(0).calledWith(request, expectedOptions));
        });
    ...
    describe('mutateRows', () => {
        it('invokes mutateRows without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.bigtable.v2.MutateRowsRequest());
            const expectedHeaderRequestParamsObj: {[key: string]: string} = {};
            // path template: {table_name=projects/*/instances/*/tables/*}
            request.tableName = 'projects/value/instances/value/tables/value';
            expectedHeaderRequestParamsObj['table_name'] = 'projects%2Fvalue%2Finstances%2Fvalue%2Ftables%2Fvalue';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.bigtable.v2.MutateRowsResponse());
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.mutateRows as SinonStub)
                .getCall(0).calledWith(request, expectedOptions));
        });
