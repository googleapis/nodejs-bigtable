...
export class BigtableClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this.descriptors.stream = {
      ...
      sampleRowKeys: new this._gaxModule.StreamDescriptor(gax.StreamType.SERVER_STREAMING, opts.fallback === 'rest'),
      mutateRows: new this._gaxModule.StreamDescriptor(gax.StreamType.SERVER_STREAMING, opts.fallback === 'rest')
    };
  ...
  initialize() {
    ...
    const bigtableStubMethods =
        ['readRows', 'sampleRowKeys', 'mutateRow', 'mutateRows', 'checkAndMutateRow', 'pingAndWarm', 'readModifyWriteRow'];
 ...
 */
  ...
  mutateRow(
    ...
    options.otherArgs.headers = options.otherArgs.headers || {};let routingParameter = {};
      if ((typeof request.tableName !== "undefined") && RegExp('(?<table_name>projects)/[^/]+/instances/[^/]+/tables/[^/]+').test(request.tableName!)){
        Object.assign(routingParameter, { table_name: request.tableName!.match(RegExp('(?<table_name>projects/[^/]+/instances/[^/]+/tables/[^/]+)'))![0]})}

      if ((typeof request.appProfileId !== "undefined") && RegExp('[^/]+').test(request.appProfileId!)){
        Object.assign(routingParameter, { app_profile_id: request.appProfileId!.match(RegExp('[^/]+'))![0]})}
 ...
 */
  pingAndWarm(
      ...
      Promise<[
        ...
        protos.google.bigtable.v2.IPingAndWarmRequest|undefined, {}|undefined
      ]>;
  pingAndWarm(
      request: protos.google.bigtable.v2.IPingAndWarmRequest,
      options: CallOptions,
  ...
  pingAndWarm(
    ...
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};let routingParameter = {};
      if ((typeof request.name !== "undefined") && RegExp('(?<name>projects)/[^/]+/instances/[^/]+').test(request.name!)){
        Object.assign(routingParameter, { name: request.name!.match(RegExp('(?<name>projects/[^/]+/instances/[^/]+)'))![0]})}
