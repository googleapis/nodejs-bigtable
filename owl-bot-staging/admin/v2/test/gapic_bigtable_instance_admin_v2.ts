...
describe('v2.BigtableInstanceAdminClient', () => {
    ...
    describe('partialUpdateCluster', () => {
        it('invokes partialUpdateCluster without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.bigtable.admin.v2.PartialUpdateClusterRequest());
            request.cluster = {};
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.partialUpdateCluster as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listHotTablets', () => {
        it('invokes listHotTablets without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listHotTablets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
