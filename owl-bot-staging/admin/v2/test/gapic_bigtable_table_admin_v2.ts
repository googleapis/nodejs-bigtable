...
describe('v2.BigtableTableAdminClient', () => {
    describe('Common methods', () => {
        ...
        it('sets apiEndpoint according to universe domain camelCase', () => {
            const client = new bigtabletableadminModule.v2.BigtableTableAdminClient({universeDomain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'bigtableadmin.example.com');
        });

        it('sets apiEndpoint according to universe domain snakeCase', () => {
            const client = new bigtabletableadminModule.v2.BigtableTableAdminClient({universe_domain: 'example.com'});
            const servicePath = client.apiEndpoint;
            assert.strictEqual(servicePath, 'bigtableadmin.example.com');
        });
        ...
        if (typeof process === 'object' && 'env' in process) {
            describe('GOOGLE_CLOUD_UNIVERSE_DOMAIN environment variable', () => {
                ...
                it('value configured in code has priority over environment variable', () => {
                    const saved = process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
                    process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = 'example.com';
                    const client = new bigtabletableadminModule.v2.BigtableTableAdminClient({universeDomain: 'configured.example.com'});
                    const servicePath = client.apiEndpoint;
                    assert.strictEqual(servicePath, 'bigtableadmin.configured.example.com');
                    if (saved) {
                        process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'] = saved;
                    } else {
                        delete process.env['GOOGLE_CLOUD_UNIVERSE_DOMAIN'];
        ...
        it('does not allow setting both universeDomain and universe_domain', () => {
            assert.throws(() => { new bigtabletableadminModule.v2.BigtableTableAdminClient({universe_domain: 'example.com', universeDomain: 'example.net'}); });
        });
    ...
    describe('createTable', () => {
        it('invokes createTable without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.CreateTableRequest', ['parent']);
            ...
            const actualRequest = (client.innerApiCalls.createTable as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createTable as SinonStub)
    ...
    describe('getTable', () => {
        it('invokes getTable without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.GetTableRequest', ['name']);
    ...
    describe('deleteTable', () => {
        it('invokes deleteTable without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.DeleteTableRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getAuthorizedView', () => {
        it('invokes getAuthorizedView without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.GetAuthorizedViewRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getAuthorizedView as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getAuthorizedView as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getAuthorizedView without error using callback', async () => {
            ...
            client.innerApiCalls.getAuthorizedView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getAuthorizedView(
                    request,
                    (err?: Error|null, result?: protos.google.bigtable.admin.v2.IAuthorizedView|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getAuthorizedView with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getAuthorizedView = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteAuthorizedView', () => {
        it('invokes deleteAuthorizedView without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.DeleteAuthorizedViewRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            );
            client.innerApiCalls.deleteAuthorizedView = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteAuthorizedView(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteAuthorizedView as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteAuthorizedView as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteAuthorizedView without error using callback', async () => {
            ...
            client.innerApiCalls.deleteAuthorizedView = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteAuthorizedView with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteAuthorizedView = stubSimpleCall(undefined, expectedError);
    ...
    describe('modifyColumnFamilies', () => {
        it('invokes modifyColumnFamilies without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.ModifyColumnFamiliesRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.bigtable.admin.v2.Table()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.modifyColumnFamilies as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.modifyColumnFamilies as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('dropRowRange', () => {
        it('invokes dropRowRange without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.DropRowRangeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.dropRowRange as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.dropRowRange as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('generateConsistencyToken', () => {
        it('invokes generateConsistencyToken without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.GenerateConsistencyTokenRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.generateConsistencyToken as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.generateConsistencyToken as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('checkConsistency', () => {
        it('invokes checkConsistency without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.CheckConsistencyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.checkConsistency as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.checkConsistency as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('getSnapshot', () => {
        it('invokes getSnapshot without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.GetSnapshotRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('deleteSnapshot', () => {
        it('invokes deleteSnapshot without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.DeleteSnapshotRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('getBackup', () => {
        it('invokes getBackup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.GetBackupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateBackup', () => {
        it('invokes updateBackup without error', async () => {
            ...
            request.backup ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.UpdateBackupRequest', ['backup', 'name']);
    ...
    describe('deleteBackup', () => {
        it('invokes deleteBackup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.DeleteBackupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('createTableFromSnapshot', () => {
        it('invokes createTableFromSnapshot without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.CreateTableFromSnapshotRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createTableFromSnapshot as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createTableFromSnapshot as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('updateTable', () => {
        it('invokes updateTable without error', async () => {
            ...
            request.table ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.UpdateTableRequest', ['table', 'name']);
        ...
        it('invokes updateTable without error using callback', async () => {
            ...
            client.innerApiCalls.updateTable = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateTable(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.bigtable.admin.v2.ITable, protos.google.bigtable.admin.v2.IUpdateTableMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.bigtable.admin.v2.ITable, protos.google.bigtable.admin.v2.IUpdateTableMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateTable as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes updateTable with call error', async () => {
            ...
            const expectedHeaderRequestParams = `table.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateTable = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes updateTable with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `table.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateTable = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateTable(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateTable as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateTableProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateTableProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
    ...
    describe('undeleteTable', () => {
        it('invokes undeleteTable without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.UndeleteTableRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.undeleteTable = stubLongRunningCall(expectedResponse);
            const [operation] = await client.undeleteTable(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.undeleteTable as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.undeleteTable as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes undeleteTable without error using callback', async () => {
            ...
            client.innerApiCalls.undeleteTable = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.undeleteTable(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.bigtable.admin.v2.ITable, protos.google.bigtable.admin.v2.IUndeleteTableMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.bigtable.admin.v2.ITable, protos.google.bigtable.admin.v2.IUndeleteTableMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.undeleteTable as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes undeleteTable with call error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.undeleteTable = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes undeleteTable with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.undeleteTable = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.undeleteTable(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.undeleteTable as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUndeleteTableProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUndeleteTableProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUndeleteTableProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUndeleteTableProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('createAuthorizedView', () => {
        it('invokes createAuthorizedView without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.CreateAuthorizedViewRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.createAuthorizedView = stubLongRunningCall(expectedResponse);
            const [operation] = await client.createAuthorizedView(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createAuthorizedView as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createAuthorizedView as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createAuthorizedView without error using callback', async () => {
            ...
            client.innerApiCalls.createAuthorizedView = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createAuthorizedView(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.bigtable.admin.v2.IAuthorizedView, protos.google.bigtable.admin.v2.ICreateAuthorizedViewMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.bigtable.admin.v2.IAuthorizedView, protos.google.bigtable.admin.v2.ICreateAuthorizedViewMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createAuthorizedView as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes createAuthorizedView with call error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createAuthorizedView = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes createAuthorizedView with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.createAuthorizedView = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.createAuthorizedView(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.createAuthorizedView as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkCreateAuthorizedViewProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkCreateAuthorizedViewProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkCreateAuthorizedViewProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkCreateAuthorizedViewProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('updateAuthorizedView', () => {
        it('invokes updateAuthorizedView without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.UpdateAuthorizedViewRequest', ['authorizedView', 'name']);
            request.authorizedView.name = defaultValue1;
            const expectedHeaderRequestParams = `authorized_view.name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            );
            client.innerApiCalls.updateAuthorizedView = stubLongRunningCall(expectedResponse);
            const [operation] = await client.updateAuthorizedView(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateAuthorizedView as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateAuthorizedView as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateAuthorizedView without error using callback', async () => {
            ...
            client.innerApiCalls.updateAuthorizedView = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateAuthorizedView(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.bigtable.admin.v2.IAuthorizedView, protos.google.bigtable.admin.v2.IUpdateAuthorizedViewMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.bigtable.admin.v2.IAuthorizedView, protos.google.bigtable.admin.v2.IUpdateAuthorizedViewMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateAuthorizedView as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes updateAuthorizedView with call error', async () => {
            ...
            const expectedHeaderRequestParams = `authorized_view.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateAuthorizedView = stubLongRunningCall(undefined, expectedError);
        ...
        it('invokes updateAuthorizedView with LRO error', async () => {
            ...
            const expectedHeaderRequestParams = `authorized_view.name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.updateAuthorizedView = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.updateAuthorizedView(request);
            await assert.rejects(operation.promise(), expectedError);
            const actualRequest = (client.innerApiCalls.updateAuthorizedView as SinonStub)
                .getCall(0).args[0];
        ...
        it('invokes checkUpdateAuthorizedViewProgress without error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkUpdateAuthorizedViewProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });
        ...
        it('invokes checkUpdateAuthorizedViewProgress with error', async () => {
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkUpdateAuthorizedViewProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('snapshotTable', () => {
        it('invokes snapshotTable without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.SnapshotTableRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.snapshotTable as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.snapshotTable as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('createBackup', () => {
        it('invokes createBackup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.CreateBackupRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('restoreTable', () => {
        it('invokes restoreTable without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.RestoreTableRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.restoreTable as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.restoreTable as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('copyBackup', () => {
        it('invokes copyBackup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.CopyBackupRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes copyBackup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.copyBackup(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.bigtable.admin.v2.IBackup, protos.google.bigtable.admin.v2.ICopyBackupMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.bigtable.admin.v2.IBackup, protos.google.bigtable.admin.v2.ICopyBackupMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.copyBackup as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listTables', () => {
        it('invokes listTables without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.ListTablesRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listAuthorizedViews', () => {
        it('invokes listAuthorizedViews without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.ListAuthorizedViewsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.bigtable.admin.v2.AuthorizedView()),
              generateSampleMessage(new protos.google.bigtable.admin.v2.AuthorizedView()),
              generateSampleMessage(new protos.google.bigtable.admin.v2.AuthorizedView()),
            ];
            client.innerApiCalls.listAuthorizedViews = stubSimpleCall(expectedResponse);
            const [response] = await client.listAuthorizedViews(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listAuthorizedViews as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listAuthorizedViews as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listAuthorizedViews without error using callback', async () => {
            ...
            client.innerApiCalls.listAuthorizedViews = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listAuthorizedViews with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listAuthorizedViews = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listAuthorizedViewsStream without error', async () => {
            ...
            client.descriptors.page.listAuthorizedViews.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listAuthorizedViewsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.bigtable.admin.v2.AuthorizedView[] = [];
                stream.on('data', (response: protos.google.bigtable.admin.v2.AuthorizedView) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listAuthorizedViews.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listAuthorizedViews, request));
            assert(
        ...
        it('invokes listAuthorizedViewsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAuthorizedViews.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listAuthorizedViewsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.bigtable.admin.v2.AuthorizedView[] = [];
                stream.on('data', (response: protos.google.bigtable.admin.v2.AuthorizedView) => {
        ...
        it('uses async iteration with listAuthorizedViews without error', async () => {
            ...
            client.descriptors.page.listAuthorizedViews.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listAuthorizedViews with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listAuthorizedViews.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listAuthorizedViewsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.bigtable.admin.v2.IAuthorizedView[] = [];
                for await (const resource of iterable) {
    ...
    describe('listSnapshots', () => {
        it('invokes listSnapshots without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.ListSnapshotsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listBackups', () => {
        it('invokes listBackups without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.bigtable.admin.v2.ListBackupsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('Path templates', () => {
        ...
        describe('authorizedView', () => {
            ...
            client.initialize();
            client.pathTemplates.authorizedViewPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.authorizedViewPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('authorizedViewPath', () => {
                const result = client.authorizedViewPath("projectValue", "instanceValue", "tableValue", "authorizedViewValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.authorizedViewPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromAuthorizedViewName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.authorizedViewPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchAuthorizedViewFromAuthorizedViewName', () => {
                const result = client.matchAuthorizedViewFromAuthorizedViewName(fakePath);
        ...
        describe('hotTablet', () => {
            ...
            client.initialize();
            client.pathTemplates.hotTabletPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.hotTabletPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('hotTabletPath', () => {
                const result = client.hotTabletPath("projectValue", "instanceValue", "clusterValue", "hotTabletValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.hotTabletPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromHotTabletName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.hotTabletPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
