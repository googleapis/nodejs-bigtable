...
describe('v2.BigtableTableAdminClient', () => {
    ...
    describe('updateTable', () => {
        it('invokes updateTable without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.bigtable.admin.v2.UpdateTableRequest());
            request.table = {};
            request.table.name = '';
            const expectedHeaderRequestParams = "table.name=";
            const expectedOptions = {
                otherArgs: {
                    headers: {
                        'x-goog-request-params': expectedHeaderRequestParams,
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateTable as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('undeleteTable', () => {
        it('invokes undeleteTable without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.bigtable.admin.v2.UndeleteTableRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.undeleteTable as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
